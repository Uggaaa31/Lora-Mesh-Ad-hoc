...
// ================================================================
// PACKET HEADER â€” Identik di semua node & gateway
// ================================================================
struct PacketHeader {
    uint8_t packetType;
    uint8_t sourceID;
...
// ================================================================
// DATA PAYLOADS â€” Semua payload WAJIB konsisten di semua folder
// ================================================================
...
// Payload IMU fatigue detection (lora_saenab â†’ Gateway)
...
// Payload status alarm fatigue (Gateway â†’ lora_saenab)
...
// Payload safety condition flags (lora_nailah â†’ Gateway)
...
// Payload vehicle telemetry lengkap (lora_nailah â†’ Gateway, opsional)
...
// Time Sync Payload â€” Gateway broadcast epoch ke semua Node (NTP Sync)
...
// Route Discovery Diagnostic Payload â€” Node -> Gateway (pengukuran waktu pembentukan rute)
...
// START_TEST Payload â€” Gateway broadcast untuk mulai test SF/BW baru
...
// ================================================================
// PACKET HANDLER CLASS â€” Semua create methods tersedia di semua folder
// ================================================================
