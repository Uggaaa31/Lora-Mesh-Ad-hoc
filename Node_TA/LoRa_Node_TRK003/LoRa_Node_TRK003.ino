...
void handleReceivedPacket(const LoRaPacket& packet) {
    ...
    // Jika node ini adalah TRK-003 (Lantai 1) dan paket datang langsung dari Gateway (Lantai 3), kita buang!
    if (NODE_ID == 3 && packet.header.sourceID == GATEWAY_ID && packet.header.hopCount == 0) return;
